...
public enum GameErrorCode {
    ...
    STALE_ACTION(HttpStatus.CONFLICT),
    DUPLICATE_ACTION(HttpStatus.CONFLICT),
    ...
    COLLAB_INVALID_TARGET(HttpStatus.CONFLICT),
    ATTACH_CHEER_INVALID_TARGET(HttpStatus.CONFLICT),
