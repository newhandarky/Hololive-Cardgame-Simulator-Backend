...
class PlayCardTriggerConfirmPendingDecisionWriter {
    ...
    PlayCardTriggerConfirmPendingDecisionWriter(JdbcTemplate jdbcTemplate, ObjectMapper objectMapper) {
        this.jdbcTemplate = jdbcTemplate;
        this.objectMapper = objectMapper;
    }

    PlayCardFollowupDecision createTriggeredEffectConfirmPendingInteraction(
        Long matchId,
        Long userId,
        ...
        return new PlayCardFollowupDecision(decisionId, INTERACTION_TYPE_TRIGGER_EFFECT_CONFIRM);
    }
